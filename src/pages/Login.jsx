...
const Login = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-[30px] *:font-bold *:font-sans h-[800px]">
            <div className=" w-[400px] mt-[80px] px-[20px] py-[40px] border  border-[#00000026]  rounded ">
                <form onSubmit={loginUsuario}>
                    <div className="flex flex-col gap-[50px] items-center">
                        <a href="/"><img src="src/assets/logo.svg" alt="" /></a>
                        <div className="flex flex-col gap-[20px]">
                            <div className="flex flex-col gap-[25px]">
                                <div className="flex flex-col gap-[5px] *:focus:outline-[#E04300] ">
